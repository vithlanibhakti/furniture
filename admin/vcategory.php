...
<div id="main_container">
	...
	*/
	...
	$targetpage = "vcategory.php"; 	//your file name  (the name of this file)
...
<?php
		...
		<tr>
			<th>Action</th>
			<td><a href="mcategory.php?edit_id=<?php echo $r['cat_id']; ?>"><img src="images/user_edit.png" alt="edit" title="edit" border="0" />Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="vcategory.php?del_id=<?php echo $r['cat_id']; ?>"><img src="images/trash.png" alt="delete" title="delete" border="0" />Delete</a></td>
		</tr>		
		<tr>
			<th align="center" colspan="12"><a href="mcategory.php">Manage Category Details</a></th>
		</tr>
