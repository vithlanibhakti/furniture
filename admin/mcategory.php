...
<title>ADMIN PANEL | Manage Category</title>
...
{
	var cn=document.frm7.catname;
	
	if(cn.value=="")
	{
		alert("Category Name field can not be empty");
		cn.focus();
		return false;
	}
}
...
function checkcname()
{
	var name=document.frm7.catname;
	var filter=/^[a-zA-Z0-9 ]+$/;
	if(!filter.test(name.value))
	{
		alert("Category Name can not contain special characters");
		name.focus();
		return false;
	}
}
...
<div id="main_container">
    ...
    <div class="right_content">        
     <h2>Manage Category Details</h2>
         <div class="form">
         <form method="post" name="frm7" onsubmit="return validate_frm();">
         
        <table align="center" cellpadding="5" cellspacing="5">
		<tr>
		<th>Category Name:</th>
		<td><input type="text" name="catname" class="login-inner" size="50" onblur="return checkcname();" value="<?php echo $r['cat_name']; ?>"/></td>
		</tr>
		...
		<tr>
			<th colspan="2"><a href="vcategory.php">View Category Details</a></th>
		</tr>
		</table>
         </form>
         </div>  
