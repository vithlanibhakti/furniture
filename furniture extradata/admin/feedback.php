...
<?php
	...
	{
		$id = $_REQUEST['del_id'];
		$del = "delete from user_feedback where feed_id='$id'";
		$ex = mysql_query($del);
...
font-size: 16px;">&nbsp; <a href="#" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
		  ...
		  <form method="post">
                            ...
                            <tbody>
						<?php
							$sel_br = "select * from user_feedback";
							$ex_br = mysql_query($sel_br);
							while($r = mysql_fetch_array($ex_br))
							{
						?>
                                <tr>
                                    <td><?php echo $r['feed_id']; ?></td>
                                    <td><?php echo $r['fullname']; ?></td>
                                    <td><?php echo $r['f_email']; ?></td>
                                    <td><?php echo $r['f_mobile_no']; ?></td>
                                    <td><?php echo $r['product_id']; ?></td>
                                    <td><?php echo $r['f_address']; ?></td>
                                    <td><?php echo $r['f_message']; ?></td>
                                   
                                    
                             
                         
                 
                                    <Td><A href="feedback.php?del_id=<?php echo $r['feed_id']; ?>">delete</A></Td>
                                </tr>
						<?php
							}
						?>
