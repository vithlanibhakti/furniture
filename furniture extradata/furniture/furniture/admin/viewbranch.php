...
<title>ADMIN PANEL | View Branch</title>
...
<div id="main_container">
    ...
    <div class="right_content">        
     <h2>View Branch/View Showroom Details</h2>
         <div class="form">
<?php
	/*
	...
	*/
	...
	$targetpage = "viewbranch.php"; 	//your file name  (the name of this file)
...
?>
	...
	<?php
		...
		<tr>
			<th>Branch Name</th>
			<td><?php echo $r['br_name']; ?></td>
		</tr>
		<tr>
			<th>Branch Address</th>
			<td><?php echo $r['br_address']; ?></td>
		</tr>
		<tr>
		...
		<tr>
			<th>Action</th>
			<td><a href="managebranch.php?edit_id=<?php echo $r['br_id']; ?>"><img src="images/user_edit.png" alt="edit" title="edit" border="0" />Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="viewbranch.php?del_id=<?php echo $r['br_id']; ?>"><img src="images/trash.png" alt="delete" title="delete" border="0" />Delete</a></td>
		</tr>		
		<tr>
			<th align="center" colspan="12"><a href="managebranch.php">Manage Branch Details</a></th>
		</tr>
