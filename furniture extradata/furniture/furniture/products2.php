        ...
        <div class="bg-top">
        	<div class="bg-top-2">
                <div class="bg">
					...
					{
						$su = $_REQUEST['c_id'];
						$sql = "select * from subcat where cat_id='$su'";
						$res = mysql_query($sql);

						while($rr=mysql_fetch_array($res))
						{
					?>
					<li class="text-1"><a href="products3.php?su_id=<?php echo $rr['sub_id']; ?>"><?php echo $rr['sub_name']; ?></a></li>
					<?php
						}
					}
					else
					{
						$sql = "select * from subcat order by rand() limit 0,10";
						$res = mysql_query($sql);
