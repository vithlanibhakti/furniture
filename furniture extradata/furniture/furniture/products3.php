                                                ...
                                                <div class="wrapper">
                                                    ...
                                                    <article class="grid_8 omega">
                                                        <div class="indent-right">
                                                            <h3 class="p2">Subcategory</h3>
                                                            <div class="wrapper prev-indent-bot2">
                                                               <div class="extra-wrap">
															   <ul>
													<?php
													
													if(isset($_REQUEST['su_id']))
													{
														$pr = $_REQUEST['su_id'];
														$sql = "select * from product where sub_id='$pr'";
														$res = mysql_query($sql);
								
														while($rr=mysql_fetch_array($res))
														{
													?>
													<li class="text-1"><a href="products4.php?p_id=<?php echo $rr['pro_id']; ?>"><?php echo $rr['pro_name']; ?><br><img src="admin/photo/<?php echo $rr['pro_img']; ?>" height="100px" width="150px" /><br></a></li>
													<?php
														}
													}
													?>	
