        	...
        	<div class="main">
            	<div class="container_12">
                	<div class="grid_9">
                    	<h1>&nbsp;</h1>
                   	  <h1>&nbsp;</h1>
                    	<h1><a class="logo" href="index.php">BRIL<strong>LI</strong>ANT</a>
                    	  <span>FURNITURE</span>
                  	  </h1>
                    </div>
                    <div class="grid_3">
                                        ...
                                        <div class="wrapper">
                                            <div class="grid_12">
                                            	<div class="indent-left">
                                                	<h3 class="p2">Regestration Form :</h3>
                                                    <form id="contact-form" method="post" enctype="multipart/form-data">                    
                                                        <fieldset>
                                                              ...
                                                              <label><span class="text-form">Password:</span><input name="p2" type="password" /></label> 
                                                              <label><span class="text-form">Date of birth:</span><input name="p2" type="text" /></label>     
                                                              <label><span class="text-form">Phone:</span><input name="p3" type="text" /></label>      
                                                              <label><span class="text-form">Country:</span><input name="p2" type="text" /></label>   
                                                              <label><span class="text-form">State:</span><input name="p2" type="text" /></label>   
                                                              <label><span class="text-form">City:</span><input name="p2" type="text" /></label>                              
                                                              <div class="wrapper"><div class="text-form">Address:</div><textarea></textarea>
