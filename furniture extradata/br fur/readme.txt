...
======================================================================
   ...
   - Copy all the files from the 'site' directory to the appropriate (usually 'www' or 'public_php') directory on your hosting. That's it.
   - This template may be edited with any php editor. If you do not know where to get one, you may consider trying NotePad++. It can be downloaded at notepad-plus.sourceforge.net and it's free.
