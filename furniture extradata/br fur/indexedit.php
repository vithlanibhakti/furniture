        ...
        <div class="row-2">
        	<div class="main">
            	<div class="container_12">
                	<div class="grid_9">
                    	<h1>
                            <a class="logo" href="index.php">Int<strong>e</strong>rior</a>
                            <span>Design</span>
                        </h1>
                    </div>
                    <div class="grid_3">
                            	...
                            	<div class="wrapper indent-bot">
                                    ...
                                    <div id="thumbs" class="navigation">
                                        <ul class="thumbs noscript">
                                            <li>
                                                <a class="thumb" href="images/iii2.jpg" title=""> <img src="images/iii.jpg" alt="" /><span></span> </a>
                                            </li> 
                                            <li>
                                ...
                                <div class="inner">
                                    <div class="wrapper">
                                        ...
                                        <div class="extra-wrap indent-top2">
                                        	<strong>Interior Design</strong> is one of <a target="_blank" href="http://blog.templatemonster.com/free-website-templates/ ">free website templates</a> created by TemplateMonster.com team. This website template is opti mized for 1024X768 screen resolution. It is also Xphp &amp; CSS valid. It has several pages: <a class="color-3" href="index.php">About</a>, <a class="color-3" href="services.php">Services</a>, <a class="color-3" href="catalogue.php">Catalogue</a>, <a class="color-3" href="pricing.php">Pricing</a>, <a class="color-3" href="contacts.php">Contact Us</a> (note that contact us form – doesn’t work).
                                        </div>
                                    </div>
                                </div>
                            </div>
            	...
            	<div class="container_12">
                	<div class="wrapper">
                    	<article class="grid_4">
                            ...
                            <p class="prev-indent-bot">This <a target="_blank" href="http://blog.templatemonster.com/2011/08/22/free-website-template-clean-style-interior/ ">
        	...
        	<div class="container_12">
            	<div class="wrapper">
                	<div class="grid_4">
                        ...
                        <div><a rel="nofollow" target="_blank" href="http://www.templatemonster.com/">Website Template</a> by TemplateMonster.com | <a rel="nofollow" target="_blank" href="http://www.php5xcss3.com/">php5xcss3.com</a></div>
                        <!-- {%FOOTER_LINK} -->
                    </div>
                    <div class="grid_4">
